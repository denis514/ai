...
- [ ] **Заход 2**: полоса «Следующий шаг» (4 шага с галочками, кликабельные)
  вместо тура; подключения Telegram/почты в карточке блока; палитра не
  открывается сама, на холсте «+ Добавить блок».
