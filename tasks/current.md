...
🔴 **Срочно:** движок зашит на `claude-sonnet-4-5` (`builder-execute:26`),
вывод модели намечен не ранее 2026-09-29 — переключить до этого.

Открытые пункты (§6 документа): дешёвые правки текста/промпта (2-6) и
движок (7-10). Ничего не начато — ждёт приоритизации владельцем.
