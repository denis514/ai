...
- ✅ **Модель «курс на узле» (node-course) — каркас + пилот**: лист может иметь свой
  ...
  - [ ] Раскатка: наполнить остальные листья ветки Projects курсами (6 шагов), затем
    другие ветки; нормализовать существующие курсы ≠6 шагов к 6 (включая Desktop 16→6).
