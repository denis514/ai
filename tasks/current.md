...
- [ ] **Рубрика «Помощь» — сверить с текущим билдером.** Справку переписывали
  11-12 июня, но 13 июня расписания/автозапуск переехали в правую панель, поэтому
  часть описаний устарела. Сторож `help-watch` сигналит об этом каждый понедельник
  с 15 июня. После сверки: `npm run help:watch -- --accept`.
