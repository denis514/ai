...
- [ ] SQL: `docs/agent-builder/migrations/012_builder_generations.sql` в SQL Editor.
- [ ] `supabase functions deploy builder-generate`
- [ ] Слить ветку. После — живой тест генерации на проде (я прогоню гостевой путь).
