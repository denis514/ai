...
- 🟡 **Вес первой загрузки.** Сделано 18-19.08: (1) контент грузится для одного
  ...
  Осталось: входной JS всё ещё выше порога 180. Внутри — содержимое, нужное карте
  сразу: `tutorials.js` 124 KB и `mindmapData.js` 85 KB. Следующий шаг — лёгкий
  индекс туториалов (массивы шагов в ленивый модуль), ~8 KB gzip, правки в 5 файлах.
