...
Долг (мелкий): шапка Atlas ещё на своей вёрстке темы — мигрировать на
`ThemeSwitcher` при следующей правке шапки; осиротевшие стили
`.account-lang-btn` и имя-редактирования панели вычистить из App.css.
