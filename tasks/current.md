...
## 🔎 Инициатива (open): умный поиск обычными словами (2026-08-22)

Стратегическая задача владельца. Исследование готово (2 прогона: клиентские
движки + серверные/семантика), план утверждён: `docs/smart-search-plan.md`,
запись в бэклоге №5a. Первый шаг — этап 1: MiniSearch + Snowball-стеммеры
ru/fi + карта синонимов, заменяет оба нынешних механизма (подстрока в карте,
префиксы в палитре). Перед началом — золотой набор запросов.
