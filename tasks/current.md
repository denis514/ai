...
- 📌 **Замечено, не трогал**: `whatsNew.js` держит 366 меток «новое/обновлено» за
  май-июнь, срока давности у них нет — июньский контент до сих пор помечается как
  новый для тех, кто его не открывал. Это решение владельца, не техника.
