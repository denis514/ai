...
- [ ] **Заход B**: чек-лист переезжает в «Детали» вертикальным списком с
  действиями (плавающая полоса с холста убирается); обратный билет из
  «Подключений» к блоку; подписи вкладок на узкой панели.
