...
**Открыто на 2026-08-18:** сверить вкладку «Помощь» в Agent Builder с текущими
возможностями билдера (сигнал повторяется каждый понедельник с 15 июня — базу
сверки никто не принимал). После сверки: `npm run help:watch -- --accept`.
