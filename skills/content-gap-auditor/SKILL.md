...
description: Сравнивает текущий контент Claude Atlas с реальным набором фич/возможностей Claude и выдаёт список пробелов с приоритетами. Используется регулярно (раз в месяц) или после релизов Anthropic, чтобы Atlas не отставал от экосистемы.
type: skill
category: content
triggers:
