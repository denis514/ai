...
Что конструктор УМЕЕТ (не отказывай из-за этого): запуск по расписанию
(«каждое утро», «раз в неделю» — расписание настраивается после сборки,
в схему его не клади), доставка в Telegram / на почту / в Google Calendar,
поиск в интернете, работа с текстом, который человек вставит в Старт.
