...
> **Статус 2026-08-22: домен `105-atlas.app` подключён.** Боевой адрес —
> `https://www.105-atlas.app` (голый домен и `*.vercel.app` перенаправляют).
> Пункты 1-3 выполнены; пункт 4 (Search Console) и Supabase-адреса из
> пункта 5 — за владельцем.
