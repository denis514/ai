...
const G = {
  ...
  'tool-mcp': {
    ru: {
      ...
      steps: [
        'Сначала добавьте сервер в окне «Подключения» → вкладка «MCP-серверы».',
  ...
  'output-telegram': {
    ru: {
      ...
      steps: [
        'Подключите Telegram в окне «Подключения».',
  ...
  'output-email': {
    ru: {
      ...
      steps: [
        'Подключите почтовый ключ в окне «Подключения».',
  ...
  'output-calendar': {
    ru: {
      ...
      steps: [
        'Подключите Google Календарь в окне «Подключения».',
