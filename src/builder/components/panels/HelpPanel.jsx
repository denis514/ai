...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      ['builder.help.tool_advanced', 'Код, Компьютер, Цитаты — продвинутые умения, они ещё дозревают: на схеме и в тестовом прогоне видны, но в реальном запуске пока не выполняют действие. Не делайте их единственным рабочим шагом.'],
    ],
  },
  {
    id: 'variables',
