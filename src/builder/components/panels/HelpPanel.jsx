...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      ['builder.help.tool_advanced', 'Код и Цитаты уже работают: Код реально считает (Python), Цитаты подкрепляют ответ ссылками на источники. Компьютер пока в реальном запуске не выполняет действие — нужна отдельная безопасная среда.'],
    ],
  },
  {
    id: 'variables',
