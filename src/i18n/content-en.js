...
export async function loadContent() {
  const [nodesCore, tutIndex, library] = await Promise.all([
    ...
    import('../locales/en/tutorials/titles.json'),
...
const TUTORIAL_LOADERS = {
  everyone:   () => import('../locales/en/tutorials/everyone.json').then(m => m.default),
  developers: () => import('../locales/en/tutorials/developers.json').then(m => m.default),
  business:   () => import('../locales/en/tutorials/business.json').then(m => m.default),
};
