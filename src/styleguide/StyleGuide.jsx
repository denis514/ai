    ...
    <div className="sg" data-sg-theme={theme}>
      ...
      <main className="sg-main">
        ...
        <Section id="header-standard" title="Стандарт шапки (ОБЯЗАТЕЛЬНО)"
          note="Единый стандарт для ВСЕХ поверхностей (Atlas, Builder, кабинет, лендинг, админка): СЛЕВА — кнопка «назад/контекст» (плашка поверхности), СПРАВА или в едином ряду инструментов — <ThemeSwitcher /> и затем <LanguageSwitcher /> ОДНИМ рядом, именно в этом порядке, всегда общими компонентами. Никаких локальных реализаций темы/языка в шапках. Дублировать переключатели в настройках страниц не нужно — они всегда доступны из шапки.">
          <div className="sg-langrow">
